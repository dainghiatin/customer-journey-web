            ...
            <table className="text-sm text-left h-full w-full">
                <tbody style={{ fontSize: "clamp(6px, 0.75vw, 14px)" }}>
                    ...
                    <tr className="border border-black">
                        ...
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.listedValue}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.transactions', 'LƯỢT GIAO DỊCH')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.transactions}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.accesses', 'LƯỢT TRUY CẬP')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.accesses}</strong></td>
                    </tr>

                    {/* Row 2 */}
                    <tr className="border border-black">
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.successfully', 'THÀNH CÔNG')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.successfully}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.amount', 'SỐ TIỀN')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.amount}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.duration', 'THỜI LƯỢNG')}:</td>
                        <td className="px-1 border border-black h-5 text-right "><strong>{metric.duration}</strong></td>
                    </tr>
                    ...
                    <tr className="border border-black">
                        ...
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.deposited}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.videoViews', 'LƯỢT XEM VIDEO')}:</td>
                        <td className="px-1 border border-black h-5 text-right "><strong>{metric.videoViews}</strong></td>  
                    </tr>

                    {/* Row 4 */}
                    <tr className="border border-black">
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.withTerm', 'CÓ KỲ HẠN')}</td>
                        <td className="px-1 border border-black h-5 text-right">{t('metrics.update', 'CẬP NHẬT')}</td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.withdrawn', 'ĐÃ RÚT')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.withdrawn}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.members', 'THÀNH VIÊN')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.members}</strong></td>
                    </tr>
                    ...
                    <tr className="border border-black">
                        ...
                        <td className="px-1 border border-black h-5 text-right "><strong>{metric.remaining}</strong></td>
                        <td className="px-1 border border-black font-bold h-5">{t('metrics.online', 'TRUY CẬP')}:</td>
                        <td className="px-1 border border-black h-5 text-right"><strong>{metric.online}</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
