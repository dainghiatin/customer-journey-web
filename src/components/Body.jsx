    ...
    return (
        <div style={{ position: "relative", marginBottom: "5vw" }}>
            <div className="hero-title" style={{ marginTop: "0px",fontWeight:"bold"  }}>
                ...
                <h4 style={{ color: "black", fontSize: '2.6vw' }}><em>(GREAT FAIRNESS - GREAT REPUTATION)</em></h4>
            </div>
            <div className="hero-subtitle" style={{ border: 0, marginTop: '3vw', alignSelf: "center", fontWeight:"bold" }}>
                ...
                <h4 style={{ color: "black", fontSize: '2.6vw' }}><em>(TARGET: NATIONAL E-COMERCIAL)</em></h4>
            </div>
            <aside className="main-aside-2" >
                <div className="main-aside-2-1" style={{ width: '19vw' , position: "absolute", bottom: '-2vw', right: '1vw', fontSize: "clamp(12px, 2vw, 40px)" }}>
                    <div style={{ color: "black", textAlign: "center",height: "clamp(20px,4vw, 60px)" }}>
                        <p><strong>Ai LIVE</strong></p>
                    </div>
                </div>
                <div className="main-aside-2-1"  style={{width: '19vw', position: "absolute", bottom: '-2vw', left: '1vw',  textAlign: "center"  }}>
                    <div style={{ fontSize: "clamp(5px, 1vw, 20px)", color: "black",height:"clamp(20px,4vw, 60px)" }}>
                        <p><strong>ĐĂNG BÀI MỚI</strong></p><p><em>(NEW POST)</em></p>
                    </div>
                </div>
                <div className="main-aside-2-2"  style={{ width: '19vw', position: "absolute", top: '3vw', left: '1vw' }}>
                    <div style={{ color: "black", textAlign: "center", fontSize: "clamp(5px, 1vw, 20px)",height:"clamp(20px,4vw, 60px)"}}>
                        <p><strong>THỊ TRƯỜNG VIỆC LÀM</strong></p>
                        {/* <p><strong>VIỆC LÀM TỰ DO</strong></p> */}
                        <p style={{ fontStyle: "italic", fontWeight: "normal" }}>(FREE JOB MARKET)</p>
                    </div>
                </div>
                <div className="main-aside-2-2" style={{ width: '19vw', position: "absolute", top: "3vw", right: '1vw' }}>
                    <div style={{ color: "black", fontSize: "clamp(5px, 1vw, 20px)", textAlign: "center",height:"clamp(20px,4vw, 60px)" }}>
                        <p><strong>GIAO DỊCH THANH TOÁN</strong></p><p><em>(PAYMENT TRANSACTION)</em></p>
                    </div>
                </div>
            </aside>
        </div>
        ...
        <div style={{ width: "50%", position: "relative" }}>
            ...
            >
                <div className='flex grow items-center justify-center'>
                    <span>{selected} <span style={{fontWeight:'normal', fontStyle:"italic"}}>({selected_en})</span></span>
                </div>
    ...
    return (
        <section className="action-section" style={{}}>
            ...
            <div className="action-section-1-mobile" style={{ justifyContent: "space-between"}}>
                <div style={{ backgroundColor: "white", aspectRatio: 3/4, width: '30%' }}>
                    <h3>SỰ KIỆN</h3>
                    <h4><em>(EVENT)</em></h4>
                    {/* <h5><em>(slide cập nhật)</em></h5> */}
                </div>
...
const DropdownAuth = () => {
    ...
    return (
        <div style={{ position: 'relative', display: "flex", flexDirection: "column", width: 'fit-content' }}>
            ...
            >
                ĐĂNG NHẬP
                <div style={{ fontSize: "clamp(10px, 1vw, 20px)", fontStyle: 'italic' }}>(LOGIN)</div>
            </button>
            <button
            ...
            >
                ĐĂNG KÝ
                <div style={{ fontSize: "clamp(10px, 1vw, 20px)", fontStyle: 'italic' }}>(REGISTER)</div>
            </button>
        </div>
    );
};
    ...
    return (
        <section className="search-section">
            <div className="search-title">
                <h3><strong>TÌM KIẾM</strong></h3><h4><em>(SEARCH)</em></h4>
            </div>
            {/* <div>
