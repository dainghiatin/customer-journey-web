        ...
        <div className="p-4 text-sm text-black space-y-2">
          ...
          <ul className="list-disc ml-4 space-y-1">
            ...
            <li>
              ...
              hiển thị AVATAR người mình theo dõi trong thư mục này. Trên đầu
              các AVATAR này hiển thị số cập nhật bài đăng video mới của người
              này mà mình chưa xem. Ấn vào các AVATAR của họ đến đến trang 8 -
              Ai LIVE - VIDEO của họ để xem các thư mục chứa các video của họ
              (không xem được họ đang theo dõi ai và ai đang theo dõi họ). Ấn
              vào các thư mục chứa video này để xem các video của họ.
            </li>
            <li>
            ...
            <li>
              <strong>Các THƯ MỤC VIDEO:</strong> có hiển thị tổng số lượt xem
              và chứa các video được sắp xếp theo thời gian đăng bài.
            </li>
            <li>
              Thời hạn tồn tại của các video là 365 ngày, sau đó hệ thống sẽ tự
              động XÓA, và đã đăng video thì không xóa được (trừ admin).
            </li>
            <li>
              <strong>THƯ MỤC LƯU:</strong> hiển thị số lượng video đã lưu. Ấn
              để vào bên trong chứa các video đã lưu.
            </li>
            <li>
              <strong>THƯ MỤC VI PHẠM:</strong> Các video bị báo cáo 1 lần vi
              phạm sẽ chuyển sang mục này.
            </li>
            <li>
              <button
    ...
    {[
      ...
      <div className="grid grid-cols-2 border-l border-r border-b border-black">
        ...
        <div className="p-4 h-screen flex flex-col">
          <div className="text-center font-bold mb-4">VIDEO</div>

          <div className="border border-black p-4 flex-1 flex flex-col">
            <div className="mb-4">
              <div className="text-sm mb-2 text-center">
                <span className="font-bold">AVATAR:</span> Tên VIDEO
              </div>
